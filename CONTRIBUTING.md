...
The **frontend** ships as part of this repository (Vue 3 + Element Plus + TypeScript, NexCore UI design system). If you only work on the backend, you can rely on pre-built assets in `web/html/` or rebuild the frontend once (see below).
...
1. **Frontend** (Vue 3 + Element Plus,位于 `frontend/`):
